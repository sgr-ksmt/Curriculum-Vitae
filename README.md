...
- [履歴書](https://proff.io/p/182DSEcM-6I9dlwxjigaAg) 参照。

## Summary

- エンジニア
- 主軸はiOSアプリ開発、最近はFirebaseを使ったフロントエンド、バックエンド開発もしている
- 現在3社目。現職はクックパッド株式会社
- 受託、自社サービス開発経験あり
...
- 勉強会で時折登壇している
- 最近は本業以外にも副業で開発を請け負っている

## Status
- 求職中

詳細は[条件](conditions)をご覧ください。
...
| 期間                         | 内容                                                                                                                                                                                                                                                                                          | 役割/開発チーム規模                |
| :--------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------- |
| 2017/08<br />〜<br />2017/11 | 新規事業のβ版作成と検証を2つのアプリで行った。(内容は言えない)。<br />iOSアプリのみ、Firebaseを使ったMVPとして作成                                                                                                                                                                            | iOSエンジニア<br /><br /> 8名程度  |
